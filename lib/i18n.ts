...
const baseTranslations: Record<'tr' | 'nl' | 'en', TranslationTree> = {
  tr: {
    ...
    gallery: {
      ...
      designChooseFormat: 'Tasarim icin once A3 poster veya Instagram story sec.',
      designPosterActive: 'A3 poster modu acik. En fazla 12 fotograf sec.',
      designStoryActive: 'Instagram story modu acik. En fazla 4 fotograf sec.',
      designSelected: 'secildi',
      designLimitReached: 'Maksimum sayiya ulastin.',
      designChangeFormat: 'Formati degistir',
      designSwitchConfirm: 'Format degisirse mevcut secim temizlenecek. Devam edilsin mi?',
      designCreate: 'Olustur',
      clearSelection: 'Secimi temizle',
      posterLimitReached: '12 fotograf secildi. Poster hazir.',
      posterMoreNeeded: 'fotograf daha secersen poster dolacak.',
      posterLimitExceeded: 'Poster sadece ilk 12 fotografi kullanacak.',
      posterExtraIgnored: 'fazla secim poster icin kullanilmayacak.',
      posterBlackWhite: 'Siyah-beyaz',
      posterStyleTitle: 'Poster rengi sec',
      posterStyleDescription: 'A3 poster en fazla 12 foto, Instagram story en fazla 4 foto kullanir.',
      posterColorOption: 'Renkli poster (12 foto)',
      posterBlackWhiteOption: 'Siyah-beyaz poster (12 foto)',
      storyOption: 'Instagram story (4 foto)',
  ...
  nl: {
    ...
    gallery: {
      ...
      designStoryActive: 'Instagram story actief. Kies maximaal 4 foto’s.',
      ...
      posterStyleDescription: 'A3-poster gebruikt maximaal 12 foto’s, Instagram story maximaal 4 foto’s.',
      posterColorOption: 'Kleur poster (12 foto’s)',
      posterBlackWhiteOption: 'Zwart-wit poster (12 foto’s)',
      storyOption: 'Instagram story (4 foto’s)',
      storyButton: 'Instagram story',
  ...
  en: {
    ...
    gallery: {
      ...
      designStoryActive: 'Instagram story mode. Select up to 4 photos.',
      ...
      posterStyleDescription: 'A3 poster uses up to 12 photos, Instagram story uses up to 4 photos.',
      posterColorOption: 'Color poster (12 photos)',
      posterBlackWhiteOption: 'Black and white poster (12 photos)',
      storyOption: 'Instagram story (4 photos)',
      storyButton: 'Instagram story',
...
const germanTranslation: TranslationTree = {
  ...
  gallery: {
    ...
    designStoryActive: 'Instagram Story aktiv. Wählen Sie bis zu 4 Fotos.',
    ...
    posterStyleDescription: 'Das A3-Poster verwendet bis zu 12 Fotos, die Instagram Story bis zu 4.',
    posterColorOption: 'Farbposter (12 Fotos)', posterBlackWhiteOption: 'Schwarz-Weiß-Poster (12 Fotos)',
    storyOption: 'Instagram Story (4 Fotos)', storyButton: 'Instagram Story',
...
const frenchTranslation: TranslationTree = {
  ...
  gallery: {
    ...
    designStoryActive: 'Mode Story Instagram. Sélectionnez jusqu’à 4 photos.',
    ...
    posterStyleDescription: "Le poster A3 utilise jusqu’à 12 photos et la Story Instagram jusqu’à 4.",
    posterColorOption: 'Poster couleur (12 photos)', posterBlackWhiteOption: 'Poster noir et blanc (12 photos)',
    storyOption: 'Story Instagram (4 photos)', storyButton: 'Story Instagram',
