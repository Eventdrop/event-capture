...
const baseTranslations: Record<'tr' | 'nl' | 'en', TranslationTree> = {
  tr: {
    ...
    gallery: {
      ...
      designChooseMode: 'Once tasarim modunu sec.',
      designChoosePosterMode: 'Poster modunu sec.',
      designChooseStoryMode: 'Story modunu sec.',
      designPosterActive: 'A3 poster modu acik. En fazla 12 fotograf sec.',
      designStoryActive: 'Instagram story modu acik. Secili moda gore fotograf sec.',
      designSelected: 'secildi',
      designLimitReached: 'Maksimum sayiya ulastin.',
      designPortraitLimitReached: 'Dikey fotograf limiti doldu.',
      designLandscapeLimitReached: 'Yatay fotograf limiti doldu.',
      ...
      designPortraitFitsBetter: 'Bu fotograf Portrait moduna daha uygun.',
      designLandscapeFitsBetter: 'Bu fotograf Landscape moduna daha uygun.',
      designOrientationPending: 'Fotograf yonu hazirlaniyor. Bir saniye sonra tekrar dene.',
      designNeutralDisabled: 'Bu poster icin dikey veya yatay bir fotograf sec.',
      designMixedHint: 'Mixed poster icin 8 dikey ve 4 yatay fotograf sec.',
      designMixedIncomplete: 'Mixed poster 8 dikey ve 4 yatay fotograf tamamlaninca olusturulur.',
      ...
      posterStyleDescription: 'A3 poster 12 foto, Instagram story moda gore 4 veya 8 foto kullanir.',
