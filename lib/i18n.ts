...
const baseTranslations: Record<'tr' | 'nl' | 'en', TranslationTree> = {
  tr: {
    ...
    gallery: {
      ...
      posterStyleDescription: 'A3 poster en fazla 15 foto, Instagram story en fazla 8 foto kullanir.',
  ...
  nl: {
    ...
    gallery: {
      ...
      posterStyleDescription: 'A3-poster gebruikt maximaal 15 foto’s, Instagram story maximaal 8 foto’s.',
  ...
  en: {
    ...
    gallery: {
      ...
      posterStyleDescription: 'A3 poster uses up to 15 photos, Instagram story uses up to 8 photos.',
...
const germanTranslation: TranslationTree = {
  ...
  gallery: {
    ...
    albumPackageLabel: 'Paket', backToUpload: 'Hochladen', posterButton: 'A3-Poster',
    posterPreparing: 'Poster wird vorbereitet ...', posterChoose: 'Wählen Sie bis zu 15 Fotos für das Poster.',
    posterLimitReached: '15 Fotos ausgewählt. Das Poster ist bereit.',
    posterMoreNeeded: 'weitere Fotos, um das Poster zu füllen.',
    posterLimitExceeded: 'Für das Poster werden nur die ersten 15 Fotos verwendet.',
    ...
    posterStyleDescription: 'Das A3-Poster verwendet bis zu 15 Fotos, die Instagram Story bis zu 8.',
    posterColorOption: 'Farbposter (15 Fotos)', posterBlackWhiteOption: 'Schwarz-Weiß-Poster (15 Fotos)',
    storyOption: 'Instagram Story (8 Fotos)', storyButton: 'Instagram Story',
    ...
    posterLimitPopup: '15 Fotos ausgewählt. Ein A3-Poster verwendet höchstens 15 Fotos. Weitere Fotos bleiben für den Album-Download verfügbar.',
...
const frenchTranslation: TranslationTree = {
  ...
  gallery: {
    ...
    albumPackageLabel: 'Lot', backToUpload: 'Ajouter', posterButton: 'Poster A3',
    posterPreparing: 'Préparation du poster…', posterChoose: "Sélectionnez jusqu’à 15 photos pour le poster.",
    posterLimitReached: '15 photos sélectionnées. Le poster est prêt.', posterMoreNeeded: 'photos supplémentaires pour remplir le poster.',
    posterLimitExceeded: 'Seules les 15 premières photos seront utilisées pour le poster.',
    ...
    posterStyleDescription: "Le poster A3 utilise jusqu’à 15 photos et la Story Instagram jusqu’à 8.",
    posterColorOption: 'Poster couleur (15 photos)', posterBlackWhiteOption: 'Poster noir et blanc (15 photos)',
    storyOption: 'Story Instagram (8 photos)', storyButton: 'Story Instagram',
    ...
    posterLimitPopup: '15 photos sélectionnées. Un poster A3 utilise au maximum 15 photos. Les autres restent disponibles pour le téléchargement de l’album.',
