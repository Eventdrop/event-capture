...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_#f7efe3,_#f6f4ee_40%,_#efe8dc_100%)] text-stone-900">
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center gap-16 px-6 py-20 md:px-10 lg:flex-row lg:items-center lg:gap-12">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-stone-700">
            EventDrop lets guests scan a QR code, upload their own photos and
        ...
        <div className="w-full max-w-xl rounded-[2rem] border border-white/60 bg-white/70 p-6 shadow-[0_20px_60px_rgba(64,45,22,0.12)] backdrop-blur">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-stone-200 bg-stone-50 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-stone-700">
                Albums are built around short-lived media collection with a 48-hour
                cleanup window for uploaded files.
              </p>
            </div>
          </div>
        </div>
