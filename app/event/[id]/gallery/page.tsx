          ...
          <section className="space-y-2">
            ...
            >
              ...
              <div className="contents sm:absolute sm:inset-x-0 sm:bottom-0 sm:flex sm:flex-row sm:items-end sm:justify-between sm:gap-5 sm:px-5 sm:pb-5">
                <h1 className="absolute bottom-[54px] left-3 min-w-0 max-w-[68%] text-left text-[12px] font-black leading-[13px] text-white [text-shadow:0_2px_10px_rgba(0,0,0,0.55)] sm:static sm:max-w-none sm:flex-1 sm:text-[1.75rem] sm:leading-none">
                  {eventName}
                </h1>
