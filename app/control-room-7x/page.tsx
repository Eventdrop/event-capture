    ...
    try {
      ...
      const response = await fetch('/api/admin/events', {
        ...
        body: JSON.stringify({
          ...
          guestbookCoverImageUrl: demoCloneSource.guestbookCoverImageUrl,
          ...
          guestbookEnabled: demoCloneSource.guestbookEnabled,
          guestbookPdfTheme: demoCloneSource.guestbookPdfTheme,
